...
5. （选择）下列物理量中属于标量的是（\quad）\\
\quad A. 位移 \quad B. 速度 \quad C. 路程 \quad D. 加速度\\
6. （判断）质点是一种理想化模型，实际并不存在。（\quad）\\
7. （填空）位移是\_\_\_\_\_量，路程是\_\_\_\_\_量。物体沿圆周运动一圈，位移为\_\_\_\_\_。\\
8. 研究地球公转时，地球\_\_\_\_\_看作质点；研究地球自转时，地球\_\_\_\_\_看作质点。（填"可以"或"不可以"）
\end{practice}
...
5. （计算）一辆车从静止开始匀加速，5s内速度达到20m/s。加速度多大？\\
6. （填空）$v$-$t$图像中，图线向上倾斜表示\_\_\_\_\_运动，向下倾斜表示\_\_\_\_\_运动。\\
7. （判断）加速度越大，物体的速度一定越大。（\quad）\\
8. 一物体以$v_0=15\ \text{m/s}$运动，2s后速度变为$5\ \text{m/s}$。加速度大小和方向如何？
\end{practice}
...
5. （计算）一辆汽车以15m/s匀速行驶，突然以$-3\ \text{m/s}^2$刹车。刹车后4s末的速度多大？\\
6. （选择）由公式$x=v_0t+\frac{1}{2}at^2$，下列说法正确的是（\quad）\\
\quad A. 只适用于匀加速直线运动 \quad B. 适用于任何变速运动 \quad C. 匀加和匀减速都适用，但$a$取正负号 \quad D. 只适用于匀速运动\\
7. （填空）匀变速直线运动的速度公式是\_\_\_\_\_。\\
8. （判断）匀变速直线运动的位移随时间均匀增加。（\quad）
\end{practice}
...
5. （计算）一石子从80m高处自由落下。落地时间和落地速度各是多少？（$g=10\ \text{m/s}^2$）\\
6. （选择）关于自由落体运动，下列说法正确的是（\quad）\\
\quad A. 重的物体下落快 \quad B. 物体竖直向下的运动就是自由落体\\
\quad C. 自由落体是初速为零、加速度为$g$的匀加速运动 \quad D. 自由落体与质量有关\\
7. （填空）竖直上抛到最高点的时间$t=$\_\_\_\_\_，最大高度$H=$\_\_\_\_\_。\\
8. 一名宇航员在月球上同时释放锤子和羽毛，\_\_\_\_\_先落地（月球表面无空气）。
\end{practice}
...
5. （计算）一弹簧伸长0.1m时弹力为50N。劲度系数$k$多大？\\
6. （选择）关于摩擦力，下列说法正确的是（\quad）\\
\quad A. 静止物体一定不受摩擦力 \quad B. 滑动摩擦力方向一定与运动方向相反\\
\quad C. 静摩擦力大小可以用$f=\mu N$计算 \quad D. 压力越大，滑动摩擦力不一定越大（因为$\mu$也可能变）\\
7. （填空）重心\_\_\_\_\_（一定/不一定）在物体上。质量均匀的圆环重心在\_\_\_\_\_。\\
8. （判断）滑动摩擦力的大小与接触面积大小无关。（\quad）
\end{practice}
...
5. （选择）根据牛顿第二定律，下列说法正确的是（\quad）\\
\quad A. 物体所受合外力越大，速度越大 \quad B. 合外力方向与加速度方向相同 \quad C. 合外力为零时加速度不一定为零 \quad D. 质量越大，加速度越大\\
6. （填空）牛顿第二定律的表达式是\_\_\_\_\_，$F$指\_\_\_\_\_力，$a$的方向与\_\_\_\_\_方向相同。\\
7. （计算）用$F=20\ \text{N}$的水平力拉$m=4\ \text{kg}$的物体在光滑水平面上运动。2s末物体速度多大？\\
8. （判断）物体所受合外力减小时，加速度一定减小，但速度可能增大。（\quad）
\end{practice}
...
5. （填空）拔河比赛中，甲队拉乙队的力和乙队拉甲队的力是一对\_\_\_\_\_力，它们大小\_\_\_\_\_。\\
6. （判断）人推墙时，墙对人有反作用力，所以人能后退。（\quad）\\
7. 两个叠放物体一起加速运动，求整体加速度用\_\_\_\_\_法，求两物体间作用力用\_\_\_\_\_法。\\
8. （选择）一本书静止在水平桌面上，下列说法正确的是（\quad）\\
\quad A. 书的重力和书对桌面的压力是平衡力 \quad B. 书的重力和桌面对书的支持力是平衡力\\
\quad C. 书对桌面的压力和桌面对书的支持力是平衡力 \quad D. 书的重力和桌面对书的支持力是相互作用力
\end{practice}
...
5. （计算）质量50kg的人站在电梯中，电梯以$2\ \text{m/s}^2$加速上升。人对电梯的压力多大？（$g=10$）\\
6. （选择）关于超重和失重，下列说法正确的是（\quad）\\
\quad A. 超重时重力变大 \quad B. 失重时重力变小 \quad C. 超重和失重时重力不变 \quad D. 完全失重时物体不受重力\\
7. （填空）物体具有向上的加速度时处于\_\_\_\_\_状态；具有向下的加速度时处于\_\_\_\_\_状态。\\
8. （判断）减速下降的电梯中，人处于超重状态。（\quad）
\end{practice}
...
5. （选择）对于连接体问题，下列说法正确的是（\quad）\\
\quad A. 整体法可以求内力 \quad B. 隔离法可以求内力 \quad C. 整体法无法求加速度 \quad D. 隔离法无法求加速度\\
6. （填空）传送带问题的关键是要分析物体相对传送带的\_\_\_\_\_方向，从而确定摩擦力的方向。\\
7. （计算）$m=5\ \text{kg}$的物体放在水平传送带上，$\mu=0.2$，$g=10$。物体刚放上时加速度多大？\\
8. （判断）斜面上的物体恰好匀速下滑时，$\mu=\tan\theta$成立。（\quad）
\end{practice}
...
\textbf{第二课 练一练：}
1. $a = \dfrac{10-30}{5} = -4\ \text{m/s}^2$，减速\quad
2. ×（匀速直线运动时$a=0$但$v\neq0$）\quad
3. 加速度，位移\quad
4. $v=0$，$a=g$（约$10\ \text{m/s}^2$）\quad
5. $a=\Delta v/\Delta t=20/5=4\ \text{m/s}^2$\quad
6. 匀加速，匀减速\quad
7. ×（加速度与速度大小无关）\quad
8. $a=(5-15)/2=-5\ \text{m/s}^2$，方向与初速度相反

\textbf{第三课 练一练：}
1. （1）$v=v_0+at=0+2\times5=10\ \text{m/s}$；\quad（2）$x=\frac{1}{2}at^2=\frac{1}{2}\times2\times25=25\ \text{m}$\quad
2. $aT^2$\quad
3. $v^2-v_0^2=2ax$ → $0-400=2\times(-5)\times x$ → $x=40\ \text{m}$\quad
4. $\surd$\quad
5. $v=v_0+at=15+(-3)\times4=3\ \text{m/s}$\quad
6. C\quad
7. $v=v_0+at$\quad
8. ×（匀变速位移与时间二次方有关，不是均匀增加）

\textbf{第四课 练一练：}
1. ×（忽略空气阻力时，所有物体下落一样快）\quad
2. $t=\sqrt{2h/g}=\sqrt{90/10}=3\ \text{s}$\quad
3. $H=v_0^2/(2g)=900/20=45\ \text{m}$\quad
4. 0，$g$\quad
5. $t=\sqrt{2h/g}=\sqrt{160/10}=4\ \text{s}$，$v=gt=40\ \text{m/s}$\quad
6. C\quad
7. $t=v_0/g$，$H=v_0^2/(2g)$\quad
8. 同时落地

\textbf{第五课 练一练：}
1. ×（摩擦力不一定是阻力，如人走路时摩擦力向前推动人）\quad
2. $F=kx=200\times0.05=10\ \text{N}$\quad
3. 正压力，不一定\quad
4. 前\quad
5. $k=F/x=50/0.1=500\ \text{N/m}$\quad
6. D\quad
7. 不一定，圆心\quad
8. $\surd$

\textbf{第七课 练一练：}
1. ×（合外力决定加速度，与速度大小无关）\quad
2. $a=F/m=12/3=4\ \text{m/s}^2$\quad
3. 合外力，相同\quad
4. $N=mg=100\ \text{N}$，$f=\mu N=30\ \text{N}$，$F_{\text{合}}=50-30=20\ \text{N}$，$a=20/10=2\ \text{m/s}^2$\quad
5. B\quad
6. $F_{\text{合}}=ma$，合外，合外力\quad
7. $a=F/m=5\ \text{m/s}^2$，$v=at=10\ \text{m/s}$\quad
8. $\surd$（加速度与合外力变化同步，速度方向与加速度同向时速度仍增大）

\textbf{第八课 练一练：}
1. ×（作用在不同物体上，不能相互抵消）\quad
2. 平衡力\quad
3. B\quad
4. A\quad
5. 相互作用，相等\quad
...
\textbf{第九课 练一练：}
1. ×（重力不变，超重是支持力变大）\quad
2. 失重\quad
3. C\quad
4. 向下（竖直向下），失重\quad
5. $N=m(g+a)=50\times12=600\ \text{N}$，由牛顿第三定律，人对电梯压力也为600N\quad
6. C\quad
7. 超重，失重\quad
8. $\surd$（减速下降$a$向上→超重）

\textbf{第十课 练一练：}
1. $a=F/(m_A+m_B)=20/5=4\ \text{m/s}^2$；绳拉力$T=m_Ba=3\times4=12\ \text{N}$\quad
2. $\mu$\quad
3. ×（传送带上滑动摩擦力可以是动力）\quad
4. 向上（竖直向上），超重\quad
5. B\quad
6. 运动趋势\quad
7. $a=\mu g=2\ \text{m/s}^2$\quad
8. $\surd$
