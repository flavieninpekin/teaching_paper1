...
\textbf{习题1}
\begin{enumerate}
\item[(1)] (a) $4x-y$ \qquad (b) $a^2-5ab+7b^2$ \qquad (c) $n$ \qquad (d) $5x^2+2xy-3$
\item[(2)] (a) $-6a^3b^4$ \qquad (b) $18x^4y^5$ \qquad (c) $2x^2-7x-4$ \qquad (d) $6a^2+5ab-6b^2$ \\ \qquad (e) $x^2-xy-6y^2$ \qquad (f) $6x^3+x^2-4x+1$
\end{enumerate}

\textbf{习题2}
\begin{enumerate}
\item[(1)] (a) $x^2-36$ \qquad (b) $9a^2-4b^2$ \qquad (c) $4x^2-9y^2$ \qquad (d) $9996$
\item[(2)] (a) $x^2+10x+25$ \qquad (b) $9a^2-12ab+4b^2$ \\ \qquad (c) $4x^2-12xy+9y^2$ \qquad (d) $39601$
\item[(3)] (a) $x^4-16$ \qquad (b) $12x$ \qquad (c) $a^2+b^2+c^2+2ab+2ac+2bc$ \\ \qquad (d) $4x^2+y^2+9z^2-4xy+12xz-6yz$
\end{enumerate}

\textbf{习题3}
\begin{enumerate}
\item[(1)] (a) $4ab(2a-3b)$ \qquad (b) $5x^2y(3x-4y+1)$ \qquad (c) $3m^2n^2(2m-3n+1)$
\item[(2)] (a) $(x+5)(x-5)$ \qquad (b) $(2a+3b)(2a-3b)$ \qquad (c) $(x+3)^2$ \\ \qquad (d) $(2a-5)^2$ \qquad (e) $(a+2)(a^2-2a+4)$ \qquad (f) $(3x-1)(9x^2+3x+1)$
\item[(3)] (a) $(x+2)(x+3)$ \qquad (b) $(x-3)(x-4)$ \qquad (c) $(x+5)(x-3)$ \\ \qquad (d) $(2x+1)(x+3)$ \qquad (e) $(3x-1)(x-3)$ \qquad (f) $(2x-3)(3x+1)$
\item[(4)] (a) $x(x+2)(x-2)$ \qquad (b) $x(x-3)^2$ \\ \qquad (c) $(x+1+y)(x+1-y)$ \qquad (d) $(a-b+1)(a-b-1)$
\end{enumerate}

\textbf{习题4}
\begin{enumerate}
\item[(1)] (a) $\dfrac{x-1}{x+1}$ \qquad (b) $\dfrac{a+2}{a-2}$ \qquad (c) $\dfrac{2xy}{3}$
\item[(2)] (a) $4\sqrt2$ \qquad (b) $6\sqrt2$ \qquad (c) $6\sqrt3$ \qquad (d) $\dfrac{\sqrt2}{2}$
\item[(3)] (a) $\sqrt2$ \qquad (b) $-\dfrac{\sqrt3}{3}$ \qquad (c) $\dfrac{2x+3}{x^2}$ \qquad (d) $\dfrac{2}{a^2-1}$
\end{enumerate}

\textbf{习题5}
\begin{enumerate}
\item[(1)] 第四象限；到$x$轴距离$2$，到$y$轴距离$3$
\item[(2)] 正比例：$y=2x$, $y=\dfrac12x$；一次：$y=2x$, $y=-x+1$, $y=\dfrac12x$；反比例：$y=\dfrac3x$
\item[(3)] (a) 与$x$轴$(\frac32,0)$，与$y$轴$(0,-3)$ \qquad (b) $y=1$ \qquad (c) $x=4$
\item[(4)] (a) 顶点$(2,-1)$，对称轴$x=2$ \qquad (b) $(1,0)$, $(3,0)$ \qquad (c) $x<1$或$x>3$
\item[(5)] $k=3$
\end{enumerate}

\textbf{习题6}
\begin{enumerate}
\item[(1)] (a) $4-3i$ \qquad (b) $2-10i$ \qquad (c) $8-i$ \qquad (d) $5$
\item[(2)] (a) 模$5$，共轭$3-4i$ \qquad (b) 模$\sqrt5$，共轭$1+2i$ \\ \qquad (c) 模$\sqrt{13}$，共轭$-2-3i$ \qquad (d) 模$5$，共轭$5$
\item[(3)] $x=\pm2i$
\item[(4)] $-i$
\end{enumerate}
