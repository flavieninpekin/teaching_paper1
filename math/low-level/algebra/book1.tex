...
\textbf{习题1}
\begin{enumerate}
\item[(1)] (a) $2x+3y$ \qquad (b) $(a-b)^2$ \qquad (c) $\dfrac34m-n=5$ \qquad (d) $n-1$和$n+1$
\item[(2)] (a) $x=18$ \qquad (b) $x=40$ \qquad (c) $x=15$ \qquad (d) $x=72$ \qquad (e) $x=7$ \qquad (f) $x=8$
\item[(3)] (a) $x=6$ \qquad (b) $x=5$ \qquad (c) $x=6$ \qquad (d) $x=6$ \qquad (e) $x=4$ \qquad (f) $x=6$
\item[(4)] (a) $7$ \qquad (b) $38$本 \qquad (c) $12$厘米
\end{enumerate}

\textbf{习题2}
\begin{enumerate}
\item[(1)] (a) $x=2$ \qquad (b) $x=\dfrac{17}{5}$ \qquad (c) $x=\dfrac92$ \qquad (d) $x=-\dfrac15$
\item[(2)] (a) $x=30$ \qquad (b) $x=3$ \qquad (c) $x=22$ \qquad (d) $x=1$
\item[(3)] (a) $30$ \qquad (b) 甲班$100$本，乙班$40$本 \qquad (c) 甲$2100$元，乙$1500$元 \qquad (d) 甲$17$岁，乙$11$岁
\end{enumerate}

\textbf{习题3}
\begin{enumerate}
\item[(1)] (a) $\begin{cases}x=5\\ y=2\end{cases}$ \qquad (b) $\begin{cases}x=\dfrac{22}{7}\\ y=\dfrac{17}{7}\end{cases}$ \qquad (c) $\begin{cases}x=3\\ y=1\end{cases}$
\item[(2)] (a) $\begin{cases}x=3\\ y=2\end{cases}$ \qquad (b) $\begin{cases}x=5\\ y=0\end{cases}$ \qquad (c) $\begin{cases}x=2\\ y=-1\end{cases}$
\item[(3)] (a) 甲$20$，乙$12$ \qquad (b) 篮球$8$个，排球$4$个 \qquad (c) 客车$6$辆，货车$6$辆
\end{enumerate}

\textbf{习题4}
\begin{enumerate}
\item[(1)] (a) $x_1=-3$, $x_2=3$ \qquad (b) $x_1=0$, $x_2=3$ \qquad (c) $x_1=-3$, $x_2=-4$ \qquad (d) $x_1=-1$, $x_2=5$ \qquad (e) $x_1=\dfrac23$, $x_2=1$ \qquad (f) $x_1=-\dfrac32$, $x_2=1$
\item[(2)] (a) $x_1=1$, $x_2=-5$ \qquad (b) $x_1=4$, $x_2=2$ \qquad (c) $x_1=9$, $x_2=-1$
\item[(3)] (a) $x=\dfrac{5\pm\sqrt{13}}{2}$ \qquad (b) $x_1=3$, $x_2=\dfrac12$ \qquad (c) $x_1=\dfrac13$, $x_2=-2$
\item[(4)] (a) $5$ \qquad (b) $6$ \qquad (c) $\dfrac56$ \qquad (d) $13$
\end{enumerate}

\textbf{习题5}
\begin{enumerate}
\item[(1)] (a) $x<3$ \qquad (b) $x>5$ \qquad (c) $x\le2$ \qquad (d) $x\ge4$
\item[(2)] (a) $-3<x<3$ \qquad (b) $2<x<4$ \qquad (c) $x\ge2$ \qquad (d) $-1<x<2$
\item[(3)] $a>0$时$x<\dfrac ba$；$a<0$时$x>\dfrac ba$；$a=0$且$b>0$时解为任意实数，$a=0$且$b\le0$时无解
\item[(4)] $50\le\text{售价}\le52$元
\end{enumerate}

\textbf{习题6}
\begin{enumerate}
\item[(1)] (a) $x=3$ \qquad (b) 无解 \qquad (c) $x=3$ \qquad (d) $x=\dfrac74$
\item[(2)] (a) $x=5$ \qquad (b) $x=3$ \qquad (c) $x=3$ \qquad (d) $x=4$
\end{enumerate}

\textbf{综合复习}
\begin{enumerate}
\item $x\in\mathbb R$（恒等式）
\item $x=\dfrac{21}{5}$
\item $\begin{cases}x=1\\ y=2\end{cases}$
\item $x_1=7$, $x_2=-1$
\item $3<x\le5$
\item $x_1=-\dfrac12$, $x_2=3$
\item $x_1=0$, $x_2=4$
\item $54$
\item 最多打$8$折
\item 甲$\dfrac{900}{11}$千米/小时，乙$\dfrac{750}{11}$千米/小时
\end{enumerate}
