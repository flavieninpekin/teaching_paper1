...
\textbf{习题1}
\begin{enumerate}
\item 余角$55^\circ$，补角$145^\circ$
\item $45^\circ$
\item $\angle2=72^\circ$，$\angle3=72^\circ$，$\angle4=108^\circ$
\item $45^\circ$
\end{enumerate}

\textbf{习题2}
\begin{enumerate}
\item $\angle C=65^\circ$
\item $100^\circ$
\item $18$或$21$
\item $40^\circ$，$40^\circ$
\item $36^\circ$，$54^\circ$
\end{enumerate}

\textbf{习题3}
\begin{enumerate}
\item $\angle D=50^\circ$，$\angle F=60^\circ$，$DE=5$
\item $AB=AD$，$\angle BAC=\angle DAC$，$AC=AC$，$\therefore\triangle ABC\cong\triangle ADC$ (SAS)
\item $AB=CD$，$\angle ABD=\angle CDB$，$BD=BD$，$\therefore\triangle ABD\cong\triangle CDB$ (SAS)
\item $\angle ACB=\angle BDA=90^\circ$，$AB=BA$，$AC=BD$，$\therefore\triangle ABC\cong\triangle BAD$ (HL)，$\therefore BC=AD$
\item $AB=AC$，$DB=DC$，$AD=AD$，$\therefore\triangle ABD\cong\triangle ACD$ (SSS)，$\therefore\angle B=\angle C$
\end{enumerate}

\textbf{习题4}
\begin{enumerate}
\item $\angle B=\angle D=60^\circ$，$\angle C=120^\circ$
\item 另一边$8$，面积$48$
\item 另一条对角线$8$
\item 正方形对角线相等（矩形性质），互相垂直平分（菱形性质）
\item 八边形
\end{enumerate}
...
\item $EC=3$，$AC=7.5$
\item $4:5$
\item $\angle1=\angle2$，$\angle A=\angle A$，$\therefore\triangle ABC\sim\triangle AED$ (AA)
\item $15$米
\end{enumerate}
...
\begin{enumerate}
\item $3$
\item $\angle BAC=60^\circ$
\item 弧长$2\pi$，扇形面积$6\pi$
\item $\angle AOB=130^\circ$
\item $90^\circ$
\end{enumerate}
