...
\subsection*{习题2}
\begin{enumerate}
  \item 设$a\perp\alpha$，$b\perp\alpha$，任取$\alpha$内一直线$c$，则$a\perp c$，$b\perp c$，故$a\parallel b$
  \item 设$\alpha\parallel\beta$，$l\perp\alpha$，任取$\beta$内一直线$m$，则$\alpha$内存在$n\parallel m$，$l\perp n$故$l\perp m$，所以$l\perp\beta$
  \item $AC\perp BD$（正方形对角线），$AC\perp BB_1$（$BB_1\perp$面$ABCD$），故$AC\perp$面$BDD_1B_1$
  \item $\arccos\dfrac13$
\end{enumerate}

\subsection*{习题3}
\begin{enumerate}
  \item $\overrightarrow{AB}\cdot\overrightarrow{AC}=-1$
  \item $(6,3,2)$（或共线的任意非零向量）
...
\subsection*{习题4}
\begin{enumerate}
  \item $V=45$，对角线长$\sqrt{43}$
  \item $V=12\pi$，$S_{\text{侧}}=15\pi$
  \item $S=144\pi$，$V=288\pi$
  \item $\dfrac{\sqrt2}{12}a^3$
  \item $2\sqrt5$
\end{enumerate}
